...
# testwallet2= Wallet.create(name: "Vacation Money", user_id: test2.id, amount:45670000000)
# testwallet3= Wallet.create(name: "General", user_id: test1.id, amount:68943200000)